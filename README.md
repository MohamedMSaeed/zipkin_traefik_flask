...
Visit the api_01's URL [ http://api_01.docker.localhost/ ]
...
To see this on Zipkin, visit Zipkin's URL [ http://zipkin.docker.localhost/zipkin/ ] then click on the search button to get traces saved.
